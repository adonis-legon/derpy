...
- [x] 1. Create AuthManager core component
...
- [x] 1.1 Implement credential storage and retrieval
...
- [x] 1.2 Implement login and logout methods
...
- [x] 1.3 Implement security features
...
- [x] 1.4 Write unit tests for AuthManager
...
- [x] 2. Enhance RegistryClient with token authentication
...
- [x] 2.1 Implement WWW-Authenticate header parsing
...
- [x] 2.2 Implement token request logic
...
- [x] 2.3 Implement automatic retry with token
...
- [x] 2.4 Add verify_authentication method
...
- [x] 2.5 Write unit tests for token authentication
...
- [x] 3. Implement login CLI command
...
- [x] 3.1 Implement credential prompting
...
- [x] 3.2 Implement authentication verification
...
- [x] 3.3 Handle registry URL normalization
...
- [x] 3.4 Write tests for login command
...
- [x] 4. Implement logout CLI command
...
- [x] 4.1 Write tests for logout command
...
- [x] 5. Integrate AuthManager with BaseImageManager
...
- [x] 5.1 Update pull_base_image method
...
- [x] 5.2 Handle authentication errors during build
...
- [x] 5.3 Handle sudo builds with user credentials
...
- [x] 5.4 Write integration tests for build with authentication
...
- [x] 6. Integrate AuthManager with push command
...
- [x] 6.1 Update push command implementation
...
- [x] 6.2 Handle push authentication errors
...
- [x] 6.3 Write tests for push with authentication
...
- [x] 8.1 Update README with authentication commands
...
- [x] 8.2 Add authentication examples
...
- [x] 8.3 Update troubleshooting section
